...
mixin _$HomeScreenModel on _HomeScreenModelBase, Store {
  ...
  @override
  GetNoteServiceModel get notes {
    _$notesAtom.reportRead();
    return super.notes;
  }

  @override
  set notes(GetNoteServiceModel value) {
  ...
  void navigateToNoteScreen(
    ...
    final _$actionInfo = _$_HomeScreenModelBaseActionController.startAction(
        name: '_HomeScreenModelBase.navigateToNoteScreen');
    try {
      return super.navigateToNoteScreen(context: context, index: index);
    } finally {
  ...
  void navigateToAddNoteScreen({required BuildContext context}) {
    final _$actionInfo = _$_HomeScreenModelBaseActionController.startAction(
        name: '_HomeScreenModelBase.navigateToAddNoteScreen');
    try {
      return super.navigateToAddNoteScreen(context: context);
    } finally {
      _$_HomeScreenModelBaseActionController.endAction(_$actionInfo);
    }
  }
